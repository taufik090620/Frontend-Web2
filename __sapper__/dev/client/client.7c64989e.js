...
const components = [
	{
		js: () => Promise.all([import('./index.8d9bf3c5.js'), __inject_styles(["index-32ca9f0c.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./register.979cc6f9.js'), ]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./login.63dd9d4d.js'), ]).then(function(x) { return x[0]; })
	}
];
