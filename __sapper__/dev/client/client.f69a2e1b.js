...
const components = [
	{
		js: () => Promise.all([import('./index.0faa95e0.js'), __inject_styles(["index-32ca9f0c.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./register.c49b8c12.js'), ]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./login.b0dce935.js'), ]).then(function(x) { return x[0]; })
	}
];
