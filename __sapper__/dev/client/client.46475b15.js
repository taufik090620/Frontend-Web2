...
const components = [
	{
		js: () => Promise.all([import('./index.68ebaac5.js'), __inject_styles(["index-32ca9f0c.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./register.b2695c58.js'), ]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./login.ad1161f7.js'), ]).then(function(x) { return x[0]; })
	}
];
