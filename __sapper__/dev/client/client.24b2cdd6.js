...
const components = [
	{
		js: () => Promise.all([import('./index.3f0e6c87.js'), __inject_styles(["index-32ca9f0c.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./register.0259c896.js'), ]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./login.76032f84.js'), ]).then(function(x) { return x[0]; })
	}
];
