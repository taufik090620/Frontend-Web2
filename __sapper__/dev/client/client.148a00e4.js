...
function create_else_block$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(a0, file$2, 49, 12, 1436);
			attr_dev(li0, "class", "nav-item");
			add_location(li0, file$2, 48, 10, 1402);
			attr_dev(a1, "href", "/register");
			attr_dev(a1, "class", "nav-link");
			add_location(a1, file$2, 52, 12, 1540);
			attr_dev(li1, "class", "nav-item");
			add_location(li1, file$2, 51, 10, 1506);
			attr_dev(ul, "class", "navbar-nav me-auto mb-2 mb-md-0");
			add_location(ul, file$2, 47, 8, 1347);
		},
...
function create_if_block$2(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(a, file$2, 43, 12, 1237);
			attr_dev(li, "class", "nav-item");
			add_location(li, file$2, 41, 10, 1145);
			attr_dev(ul, "class", "navbar-nav me-auto mb-2 mb-md-0");
			add_location(ul, file$2, 40, 8, 1090);
		},
		m: function mount(target, anchor) {
			insert_dev(target, ul, anchor);
			append_dev(ul, li);
...
function create_fragment$3(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(a, file$2, 36, 4, 1012);
			add_location(div0, file$2, 38, 4, 1059);
			attr_dev(div1, "class", "container-fluid");
			add_location(div1, file$2, 35, 2, 978);
			attr_dev(nav, "class", "navbar navbar-expand-md navbar-dark bg-dark mb-4");
			add_location(nav, file$2, 34, 0, 913);
		},
		m: function mount(target, anchor) {
...
function create_fragment$2(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			add_location(main, file$1, 6, 0, 76);
		},
		m: function mount(target, anchor) {
...
const components = [
	{
		js: () => Promise.all([import('./index.a091b54d.js'), __inject_styles(["index-32ca9f0c.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./register.0708dd63.js'), ]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./login.8cea04f0.js'), ]).then(function(x) { return x[0]; })
	}
];
