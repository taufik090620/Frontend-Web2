...
function create_else_block$1(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(a0, file$2, 51, 12, 1499);
			attr_dev(li0, "class", "nav-item");
			add_location(li0, file$2, 50, 10, 1465);
			attr_dev(a1, "href", "/register");
			attr_dev(a1, "class", "nav-link");
			add_location(a1, file$2, 54, 12, 1603);
			attr_dev(li1, "class", "nav-item");
			add_location(li1, file$2, 53, 10, 1569);
			attr_dev(ul, "class", "navbar-nav me-auto mb-2 mb-md-0");
			add_location(ul, file$2, 49, 8, 1410);
		},
...
function create_if_block$2(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(a, file$2, 45, 12, 1300);
			attr_dev(li, "class", "nav-item");
			add_location(li, file$2, 43, 10, 1208);
			attr_dev(ul, "class", "navbar-nav me-auto mb-2 mb-md-0");
			add_location(ul, file$2, 42, 8, 1153);
		},
		m: function mount(target, anchor) {
			insert_dev(target, ul, anchor);
			append_dev(ul, li);
...
function create_fragment$3(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(a, file$2, 38, 4, 1069);
			add_location(div0, file$2, 40, 4, 1116);
			attr_dev(div1, "class", "container-fluid");
			add_location(div1, file$2, 37, 2, 1035);
			attr_dev(nav, "class", "navbar navbar-expand-md navbar-dark bg-dark mb-4");
			add_location(nav, file$2, 36, 0, 970);
		},
		m: function mount(target, anchor) {
...
const components = [
	{
		js: () => Promise.all([import('./index.3d512a57.js'), __inject_styles(["index-32ca9f0c.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./register.683cb3ba.js'), ]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./login.ba417289.js'), ]).then(function(x) { return x[0]; })
	}
];
